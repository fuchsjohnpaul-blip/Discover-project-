    ...
    <main className="min-h-screen px-6 py-8 md:px-10 lg:px-12">
      <div className="mx-auto flex max-w-7xl flex-col gap-8">
        <section className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
          <div className="overflow-hidden rounded-[2rem] border bg-white/70 p-8 shadow-[0_30px_80px_rgba(68,60,42,0.12)] backdrop-blur">
          ...
          <section className="overflow-hidden rounded-[2rem] border bg-[linear-gradient(180deg,rgba(238,233,219,0.96)_0%,rgba(255,255,255,0.9)_100%)] p-4 shadow-[0_30px_80px_rgba(68,60,42,0.12)]">
            <div className="flex h-full min-h-[420px] flex-col rounded-[1.5rem] border border-dashed border-primary/30 bg-[radial-gradient(circle_at_top,#ffffff,rgba(246,240,226,0.92))] p-4">
              <div className="flex items-center justify-between rounded-2xl bg-white/80 px-4 py-3 shadow-sm">
                <div>
                  <p className="text-sm font-medium">Map Preview</p>
                  <p className="text-xs text-muted-foreground">
                    Interactive map will be added in the next build step
                  </p>
                </div>
