...
export function HomePageClient({
  ...
  const filteredRestaurants = initialRestaurants.filter((restaurant) => {
    ...
    if (activeFilter === "Dedicated GF Menu") {
      return (
        restaurant.menuItems.filter((item) => item.status === "Verified Safe")
          .length >= 2
      );
    }
          ...
          <div className="max-w-2xl">
            ...
            <div className="mt-6 max-w-2xl space-y-4">
              <h1 className="text-4xl font-semibold tracking-tight md:text-6xl">
                Discover Tuscaloosa restaurants with gluten-free confidence built
                in.
              </h1>
              ...
              <div className="flex min-h-[420px] items-center justify-center rounded-[1.5rem] border border-dashed bg-background/70 p-6 text-center">
                <div>
                  <p className="text-sm font-semibold">
                    No matching restaurant selected
                  </p>
                  <p className="mt-2 text-sm leading-6 text-muted-foreground">
